        ...
        <div class="container">
            ...
            <br>
             ...
             <div class="col-lg-12">
                ...
                <h3 class="text-warning text-center" > Display Class Data </h3>
                <br>
                <table  id="tabledata" class=" table table-striped table-hover table-bordered">
                    ...
                    while ($res = mysqli_fetch_array($query)) {
                        ...
                        <tr class="text-center">
                            ...
                            <td> <button class="btn-danger btn"> <a href="delete1.php?subject=<?php echo $res['subject']; ?>" class="text-white"> Delete </a>  </button> </td>
