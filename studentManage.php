    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
             ...
             <h3 class="text-warning text-center" > Display Student Data </h3>
                <br>
                <table  id="tabledata" class=" table table-striped table-hover table-bordered">
                    ...
                    while ($res = mysqli_fetch_array($query)) {
                        ...
                        <tr class="text-center">
                            ...
                            <td> <button class="btn-danger btn"> <a href="delete2.php?roll=<?php echo $res['roll']; ?>" class="text-white"> Delete </a>  </button> </td>
